...
@Injectable()
export class BookdtoServiceModuleServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    create(body: CreateBookDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/BookdtoServiceModule/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(body: UpdateBookDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/BookdtoServiceModule/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/BookdtoServiceModule/Delete?";
        if (id === null)
    ...
    get(id: number | undefined): Observable<BookDto> {
        let url_ = this.baseUrl + "/api/services/app/BookdtoServiceModule/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    getAll(): Observable<BookDto[]> {
        let url_ = this.baseUrl + "/api/services/app/BookdtoServiceModule/GetAll";
        url_ = url_.replace(/[?&]$/, "");
